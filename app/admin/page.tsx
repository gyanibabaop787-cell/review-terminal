...
export default function AdminDashboard() {
  ...
  return (
    <>
      {/* Mobile Block */}
      <div className="md:hidden flex flex-col items-center justify-center min-h-screen p-6 text-center animate-fade-in">
        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md max-w-sm w-full">
          ...
          <p className="text-white/60 mb-8 text-sm leading-relaxed">
            The admin panel is exclusively optimized for PC so you can comfortably read all feedbacks without scrolling. Please open this page on a larger screen.
          </p>
          <button onClick={handleLogout} className="btn w-full bg-white/10 hover:bg-white/20 text-white text-sm py-3 transition-colors">
            Logout
          </button>
        </div>
      </div>
      ...
      {/* PC Content */}
      <div className="hidden md:block container min-h-screen py-10">
